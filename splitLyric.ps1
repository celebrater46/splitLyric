...
function trimOneChar($lyric){
    ...
    } elseif(($zero -eq "k") -Or ($zero -eq "s") -Or ($zero -eq "t") -Or ($zero -eq "n") -Or ($zero -eq "h") -Or ($zero -eq "m") -Or ($zero -eq "y") -Or ($zero -eq "r") -Or ($zero -eq "w") -Or ($zero -eq "g") -Or ($zero -eq "z") -Or ($zero -eq "d") -Or ($zero -eq "b") -Or ($zero -eq "p") -Or ($zero -eq "x") -Or ($zero -eq "l") -Or ($zero -eq "c") -Or ($zero -eq "v") -Or ($zero -eq "q") -Or ($zero -eq "f") -Or ($zero -eq "j")){
